...
begin
  frm_Consulta.RadioGroup1.Tag := 15;
end;
...
begin
  ...
  query.Connection := dm_ProjetoFinal.FDFinal;
  querySelect :=
    'SELECT c.idcliente as "Nº Registro",  p.nome FROM cliente c, pessoa p where c.pessoa_idPessoa = p.idpessoa and nome =  "'
    + nome + '" ;';
...
begin
  frm_Consulta.RadioGroup1.Tag := 1;
end;
...
begin
  ...
  begin
  ShowMessage('a' + IntToStr(frm_Consulta.Tag));
    if frm_Consulta.RadioGroup1.Tag = 1 then
    begin
