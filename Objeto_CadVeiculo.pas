...
begin
  ...
  query.SQL.Add('update veiculo set modelo =:modelo, placa =:placa, marca_veiculo_idmarca_veiculo, ativo =:ativo = :marca_veiculo_idmarca_veiculo where (idveiculos = :idveiculos)');
